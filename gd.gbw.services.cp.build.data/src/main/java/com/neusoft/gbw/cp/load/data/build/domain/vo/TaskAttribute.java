...
public class TaskAttribute {
	...
	private int task_priority;          //任务优先级, 基础优先级，三满任务加入这个优先级算法
	private String validity_b_time;     //有效开始时间
	private String validity_e_time;     //有效结束时间
	private String recover_b_time;      //任务回收开始时间
	private String recover_e_time;      //任务回收结束时间
	private int sample_circle;			//采样周期
	private int sample_number;			//采样个数
	private int is_timelapse;			//是否延时下发
	private String time_lapse;			//延时时间
	private int task_status_id;			//任务下发状态：下发成功、下发失败、未下发、下发中
	private String task_status_desc;	//状态描述
	...
	public int getSample_circle() {
		return sample_circle;
	}
	public void setSample_circle(int sample_circle) {
		this.sample_circle = sample_circle;
	}
	...
	public String getRecover_b_time() {
		return recover_b_time;
	}
	public void setRecover_b_time(String recover_b_time) {
		this.recover_b_time = recover_b_time;
	}
	public String getRecover_e_time() {
		return recover_e_time;
	}
	public void setRecover_e_time(String recover_e_time) {
		this.recover_e_time = recover_e_time;
	}
