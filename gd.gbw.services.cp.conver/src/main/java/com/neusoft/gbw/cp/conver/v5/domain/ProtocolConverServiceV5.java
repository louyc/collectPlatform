...
public class ProtocolConverServiceV5 implements IProtocolConver {
	public static void main(String[] args) throws NXmlException {
		IProtocolConver iConver = ProtocolConverFactory.getInstance()
				.newProtocolConverServiceV5();
		String recoveryXMLDate = "<?xml version='1.0' encoding='GB2312' standalone='yes'?><Msg Version='5' MsgID='141216140806243' Type='RadioUp' DateTime='2014-12-16 14:08:06' SrcCode='SJZXCJD' DstCode='CBT01' ReplyID='13030779'><Return Type='EquipmentInitParamSet' Value='0' Desc='成功'></Return></Msg>";
