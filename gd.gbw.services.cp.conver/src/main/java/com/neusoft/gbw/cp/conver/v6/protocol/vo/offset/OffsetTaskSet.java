 ...
 *
 */
@XStreamAlias("OffsetTaskSet")
public class OffsetTaskSet implements IQuery {
	@XStreamAsAttribute
	...
	public QualityTask getQualityTask() {
		return qualityTask;
	}

	public void setQualityTask(QualityTask qualityTask) {
