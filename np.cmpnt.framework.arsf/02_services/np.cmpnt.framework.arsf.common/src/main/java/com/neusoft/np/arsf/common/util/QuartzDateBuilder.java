 ...
 * @see JobBuilder 
 */
public class QuartzDateBuilder {
	...
	*/
	 ...
	 * @return
	 */
	public static Date nextMinutesDateAfterNow() {
		return nextMinutesDate(new Date(),1);
	}
	
	public static Date nextMinutesDate(Date startTime,int amount){
		return DateUtils.addMinutes(startTime, amount);
	}
	
	public static Date nextHoursDateAfterNow() {
		return nextHoursDate(new Date(),1);
	}
	
	public static Date nextHoursDate(Date startTime,int amount){
		return DateUtils.addHours(startTime, amount);
	}

	public static Date nextDayDateAfterNow() {
		return nextDayDate(new Date(),1);
	}
	
	public static Date nextDayDate(Date startTime,int amount){
		return DateUtils.addDays(startTime, amount);
	}
	
	public static Date nextWeekDateAfterNow() {
		return nextWeekDate(new Date(),1);
	}
	
	public static Date nextWeekDate(Date startTime,int amount){
		return DateUtils.addWeeks(startTime, amount);
	}
	
	public static Date nextMonthDateAfterNow() {
		return nextMonthDate(new Date(),1);
	}
	
	public static Date nextMonthDate(Date startTime,int amount){
		return DateUtils.addMonths(startTime, amount);
	}
	
	public static Date nextSeasonDateAfterNow() {
		return nextSeasonDate(new Date(),1);
	}
	
	public static Date nextSeasonDate(Date startTime,int amount){
		return DateUtils.addMonths(startTime, amount*3);
	}
	
	public static Date nextYearDateAfterNow() {
		return nextMonthDate(new Date(),1);
	}
	
	public static Date nextYearDate(Date startTime,int amount){
		return DateUtils.addYears(startTime, amount);
	}
}
