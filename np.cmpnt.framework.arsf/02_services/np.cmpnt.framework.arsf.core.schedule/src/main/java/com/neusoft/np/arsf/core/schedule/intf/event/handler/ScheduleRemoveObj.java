 ...
 * 功能描述: 删除调度任务事件监听EventHandler<br>
 * 创建日期: 2015年05月19日 <br>
 ...
 * </pre>
 */
public class ScheduleRemoveObj implements BaseEventHandler {

	@Override
	public String getTopicName() {
		return ScheduleDeclare.SCHEDULE_REMOVE;
	}
	...
	public boolean processEvent(Object arg0) {
		...
		if(arg0 instanceof ScheduleMsg) {
			...
			try {
				...
				eventData.put(ScheduleConstants.TASKOPERATORTYPE, ScheduleConstants.TASKOPERATORDEL);
				TaskInfo taskInfo = TaskBuilder.buildTaskInfo(eventData);
				ScheduleFacade.delSchedule(taskInfo);
