...
import com.neusoft.gbw.cp.process.realtime.service.condition.ConditionPool;
import com.neusoft.gbw.cp.process.realtime.service.condition.TimeoutDataPool;
...
public class TaskProcessContext {
	...
	public void loadRealtimeProcess() {
		...
		Map<String, String> map = config.getAllBusinessProperty(ProcessConstants.REAL_TIME_PROCESS_SCOPE);
