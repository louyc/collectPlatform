...
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.Center;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.EquipmentInitParamSet;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.InitEquipment;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.LogInfo;
...
public class EquInitParamSetBuilder {
	...
	public static Object buildEquInitParamSet(MoniSetingDTO dto, TaskPriority taskPriority) throws BuildException {
		...
		Collections.sort(initList.get(0).getCenters(),new Comparator<Center>(){
