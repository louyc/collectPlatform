...
public class EquAlarmSetTaskHandler implements BaseEventHandler{
	
	private TaskReceiveMgr mgr = null;
	
	public EquAlarmSetTaskHandler(TaskReceiveMgr mgr) {
		this.mgr = mgr;
	}
	@Override
	public String getTopicName() {
		return EventServiceTopic.RestTopic.REST_SYNT_EQU_ALARM_SET;
	}
