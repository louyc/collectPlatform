...
import com.neusoft.gbw.cp.conver.v6.protocol.vo.kpi.QualityTaskSet;
import com.neusoft.gbw.cp.conver.v6.protocol.vo.kpi.QualityTaskSetQualityIndex;
import com.neusoft.gbw.cp.conver.v6.protocol.vo.offset.OffsetTaskSet;
import com.neusoft.gbw.cp.load.data.build.domain.vo.Task;

public class QualityTaskSetV6Builder {
...
//		qTaskSet.setEquCode(kTask.getTaskFreq().getReceiver_code()==null? "" : kTask.getTaskFreq().getReceiver_code());
		...
		qTaskSet.addQualityTask(QualityTaskBuilder.buildQualityKpiTaskV6(kTask));
	...
	public static OffsetTaskSet buildQualityOffsetTaskSet(Task oTask) {
		...
		oTaskSet.setQualityTask(QualityTaskBuilder.buildQualityOffsetTaskV6(oTask));
