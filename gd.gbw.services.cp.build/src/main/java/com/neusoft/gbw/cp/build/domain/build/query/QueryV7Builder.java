...
import com.neusoft.gbw.cp.build.domain.build.equ.EquAlarmParamSetV7Builder;
import com.neusoft.gbw.cp.build.domain.build.equ.EquInitParamSetV7Builder;
import com.neusoft.gbw.cp.build.domain.build.equ.EquipmentHistoryQueryTaskBuilder;
import com.neusoft.gbw.cp.build.domain.build.equ.EquipmentStatusTaskV7Builder;
import com.neusoft.gbw.cp.build.domain.build.equ.ProgramCommandTaskBuilder;
import com.neusoft.gbw.cp.build.domain.build.quality.QualityAlarmParamSetV7Builder;
import com.neusoft.gbw.cp.build.domain.build.quality.QualityRealtimeQueryV7Builder;
import com.neusoft.gbw.cp.build.domain.build.spectrum.SpectrumRealtimeQueryV7Builder;
...
import com.neusoft.gbw.cp.conver.v7.protocol.vo.audio.RealtimeStream;
import com.neusoft.gbw.cp.conver.v7.protocol.vo.audio.StreamRealtimeQuery;
import com.neusoft.gbw.cp.conver.v7.protocol.vo.other.FileRetrieve;
import com.neusoft.gbw.cp.conver.v7.protocol.vo.other.FileRetrieve_File;
import com.neusoft.gbw.cp.conver.v7.protocol.vo.other.TaskDelete;
import com.neusoft.gbw.cp.conver.v7.protocol.vo.other.TaskStatusQuery;
...
public class QueryV7Builder extends QueryV7SetBuilder implements IQueryBuild {
	...
	public Object buildQualityAlarmParamSet(Object obj, TaskPriority taskPriority) {
		if (obj instanceof Map) {
			...
			try {
				...
				return QualityAlarmParamSetV7Builder.buildQualityAlarmParamSet(dto, taskPriority);
			} catch (Exception e) {
				Log.error("", e);
				return null;
			}
	...
	public Object buildQualityRealtimeQuery(Object obj, TaskPriority taskPriority) {
		try {
			...
			return QualityRealtimeQueryV7Builder.buildQualityRealtimeQuery((KpiRealtimeQueryDTO)obj, taskPriority);
	...
	public Object buildSpectrumRealtimeQuery(Object obj, TaskPriority taskPriority) {
		try {
			return SpectrumRealtimeQueryV7Builder.buildSpectrumRealtimeQuery((SpectrumRealtimeQueryDTO)obj, taskPriority);
		} catch (BuildException e) {
			e.printStackTrace();
			return null;
		}
	...
	public Object buildEquAlarmParamSet(Object obj, TaskPriority taskPriority) {
		if (obj instanceof Map) {
			...
			try {
				dto = (MoniSetingDTO)ConverterUtil.xmlToObj(request);
				return EquAlarmParamSetV7Builder.buildEquAlarmParamSet(dto, taskPriority);
			} catch (Exception e) {
				return null;
			}
		}
	...
	public Object buildEquStatusRealtimeQuery(Object obj, TaskPriority taskPriority) {
		...
		try {
			return EquipmentStatusTaskV7Builder.buildRealTimeStreamEquipmentStatusQuery(monitorId, taskPriority);
		} catch (BuildException e) {
			e.printStackTrace();
			return null;
		}
	...
	public Object buildEquInitParamSet(Object obj, TaskPriority taskPriority) {
		if (obj instanceof Map) {
			...
			try {
				dto = (MoniSetingDTO)ConverterUtil.xmlToObj(request);
				return EquInitParamSetV7Builder.buildEquInitParamSet(dto,taskPriority);
			} catch (Exception e) {
				Log.error("", e);
				return null;
			}
...
//		query.setDstCode(task.getTaskMonitor().getMonitor_code());
	...
	public Object buildTaskStatusQuery(Object obj, TaskPriority taskPriority) {
		Query query = new Query();
		List<com.neusoft.gbw.cp.conver.v7.protocol.vo.other.Task> taskList = new ArrayList<com.neusoft.gbw.cp.conver.v7.protocol.vo.other.Task>();
		...
		if(obj instanceof MoniInspectResultDTO) {
			...
			for(String taskid : array) {
				com.neusoft.gbw.cp.conver.v7.protocol.vo.other.Task ptask = new com.neusoft.gbw.cp.conver.v7.protocol.vo.other.Task();
	...
	public Object buildProgramCommand(Object obj, TaskPriority taskPriority) {
		...
		try {
			...
			return ProgramCommandTaskBuilder.buildV7ProgramCommand(monitorId, ptype, taskPriority);
		} catch (Exception e) {
			Log.error("", e);
			return null;
		}
