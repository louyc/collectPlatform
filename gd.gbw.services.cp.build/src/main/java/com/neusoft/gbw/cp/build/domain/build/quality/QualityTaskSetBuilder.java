...
import com.neusoft.gbw.cp.conver.v8.protocol.vo.kpi.QualityTaskSet;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.kpi.QualityTaskSetQualityIndex;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.offset.OffsetTaskSet;
import com.neusoft.gbw.cp.load.data.build.domain.vo.Task;

public class QualityTaskSetBuilder {
...
//		qTaskSet.setEquCode("");
		...
		qTaskSet.addQualityTask(QualityTaskBuilder.buildQualityKpiTask(kTask));
	...
	public static OffsetTaskSet buildQualityOffsetTaskSet(Task oTask) {
		...
		oTaskSet.setQualityTask(QualityTaskBuilder.buildQualityOffsetTask(oTask));
