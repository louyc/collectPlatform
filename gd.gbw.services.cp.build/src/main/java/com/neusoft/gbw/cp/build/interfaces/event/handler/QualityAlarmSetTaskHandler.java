...
public class QualityAlarmSetTaskHandler implements BaseEventHandler{
	
	private TaskReceiveMgr mgr = null;
	
	public QualityAlarmSetTaskHandler(TaskReceiveMgr mgr) {
		this.mgr = mgr;
	}
	@Override
	public String getTopicName() {
		return EventServiceTopic.RestTopic.REST_SYNT_QUALITY_ALARM_SET;
	}
