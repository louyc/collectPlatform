...
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.AlarmParam;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.EquipmentAlarmParam;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.EquipmentAlarmParamSet;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.other.Param;
...
public class EquAlarmParamSetBuilder {
	...
	public static Object buildEquAlarmParamSet(MoniSetingDTO dto, TaskPriority taskPriority) throws BuildException {
		...
		String monitor_code = null;
		monitor_code = DataMgrCentreModel.getInstance().getMonitorCode(monitorID);
		if (monitor_code == null) {
			throw new BuildException("获取设备信息为空 ID=" + monitorID);
		} else {
			query.setDstCode(monitor_code);
		}
