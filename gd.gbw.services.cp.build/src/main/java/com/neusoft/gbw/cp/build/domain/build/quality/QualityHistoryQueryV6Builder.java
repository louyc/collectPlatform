...
import com.neusoft.gbw.cp.conver.v6.protocol.vo.kpi.QualityHistoryQuery;
import com.neusoft.gbw.cp.conver.v6.protocol.vo.kpi.QualityHistoryQueryQualityIndex;
import com.neusoft.gbw.cp.conver.v6.protocol.vo.offset.OffsetHistoryQuery;
import com.neusoft.gbw.cp.load.data.build.domain.vo.Task;

public class QualityHistoryQueryV6Builder {
...
//		hisQuery.setEquCode(kTask.getTaskFreq().getReceiver_code() == null ? "": kTask.getTaskFreq().getReceiver_code());
		hisQuery.setEquCode("");
		//20170105   lyc
...
//		hisQuery.setSampleNumber(kTask.getTaskConfAttr().get(BuildConstants.TASK_SAMPLE_NUMBER));
		hisQuery.setSampleNumber("1");
		hisQuery.setUnit(kTask.getTaskConfAttr().get(BuildConstants.TASK_SAMPLE_CIRCLE));
		// hisQuery.setStartDateTime(getStartDateTime(kTask)+"");
		// hisQuery.setEndDateTime(getEndDateTime(kTask)+"");
