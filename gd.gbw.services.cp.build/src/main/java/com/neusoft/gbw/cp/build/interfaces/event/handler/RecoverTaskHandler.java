...
public class RecoverTaskHandler implements BaseEventHandler{

	private TaskReceiveMgr mgr = null;
	
	public RecoverTaskHandler(TaskReceiveMgr mgr) {
		this.mgr = mgr;
	}
	
	@Override
	public String getTopicName() {
		return EventServiceTopic.RestTopic.REST_SYNT_RECOVER_TASK;
	}
