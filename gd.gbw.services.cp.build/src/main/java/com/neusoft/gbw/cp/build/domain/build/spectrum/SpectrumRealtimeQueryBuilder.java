...
import com.neusoft.gbw.cp.conver.v8.protocol.vo.spectrum.SpectrumRealtimeQuery;
...
public class SpectrumRealtimeQueryBuilder {
	...
	public static Object buildSpectrumRealtimeQuery(SpectrumRealtimeQueryDTO dto, TaskPriority taskPriority) throws BuildException {
		...
		spectrum.setFreqNumber(dto.getFreqNumber());
