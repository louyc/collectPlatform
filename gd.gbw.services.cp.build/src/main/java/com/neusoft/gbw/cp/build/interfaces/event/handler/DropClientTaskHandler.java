...
public class DropClientTaskHandler implements BaseEventHandler{
	
	private TaskReceiveMgr mgr = null;
	
	public DropClientTaskHandler(TaskReceiveMgr mgr) {
		this.mgr = mgr;
	}
	@Override
	public String getTopicName() {
		return EventServiceTopic.RestTopic.REST_SYNT_DROP_CLIENT_TASK;
	}
