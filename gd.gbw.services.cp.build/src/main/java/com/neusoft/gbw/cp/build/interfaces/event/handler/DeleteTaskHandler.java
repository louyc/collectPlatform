...
public class DeleteTaskHandler implements BaseEventHandler{

	private TaskReceiveMgr mgr = null;
	
	public DeleteTaskHandler(TaskReceiveMgr mgr) {
		this.mgr = mgr;
	}
	
	@Override
	public String getTopicName() {
		return EventServiceTopic.RestTopic.REST_SYNT_DELETE_TASK;
	}
