...
public class ControlMonitorHandler implements BaseEventHandler{

	private TaskReceiveMgr mgr = null;
	
	public ControlMonitorHandler(TaskReceiveMgr mgr) {
		this.mgr = mgr;
	}
	@Override
	public String getTopicName() {
		return EventServiceTopic.RestTopic.REST_SYNT_CONTROL_MONITOR;
	}
