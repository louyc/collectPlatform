...
import com.neusoft.gbw.cp.conver.v8.protocol.vo.kpi.QualityRealtimeQuery;
import com.neusoft.gbw.cp.conver.v8.protocol.vo.kpi.QualityRealtimeQueryQualityIndex;
...
public class QualityRealtimeQueryBuilder {
	...
	public static Object buildQualityRealtimeQuery(KpiRealtimeQueryDTO dto, TaskPriority taskPriority) throws BuildException {
		...
		long fre = Long.valueOf(dto.getFreq());
		if(fre>=2300 && fre<=26100){
			quality.setBand("0");
		}else if(fre>=531 && fre<=1602){
			quality.setBand("1");
		}else if(fre>=87000 && fre<=108000){
			quality.setBand("2");
		}
